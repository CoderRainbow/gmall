package com.jyy.gmall.admin.ums.controller;

import com.alibaba.dubbo.config.annotation.Reference;
import com.baomidou.mybatisplus.core.conditions.query.QueryWrapper;
import com.jyy.gmall.admin.ums.vo.UmsAdminLoginParam;
import com.jyy.gmall.admin.ums.vo.UmsAdminParam;
import com.jyy.gmall.admin.utils.JwtTokenUtil;
import com.jyy.gmall.to.CommonResult;
...
public class UmsAdminController {
    ...
    public Object login(@RequestBody UmsAdminLoginParam umsAdminLoginParam, BindingResult result) {
        ...
        if(admin==null) {
            System.out.println("------getId---" + admin.getId() + "------getUsername-" + admin.getUsername());
        }else{
            System.out.println("admin 对象为空");
        }
